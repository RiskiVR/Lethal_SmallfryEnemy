...
namespace SmallfryEnemy {
    ...
    public class Plugin : BaseUnityPlugin {
        ...
        private void Awake() {
            ...
            var SmallfryEnemy = ModAssets.LoadAsset<EnemyType>("Smallfry");
            var SmallfryEnemyTN = ModAssets.LoadAsset<TerminalNode>("SmallfryEnemyTN");
            var SmallfryEnemyTK = ModAssets.LoadAsset<TerminalKeyword>("SmallfryEnemyTK");

            // Optionally, we can list which levels we want to add our enemy to, while also specifying the spawn weight for each.
            /*
            var SmallfryEnemyLevelRarities = new Dictionary<Levels.LevelTypes, int> {
            ...
            var SmallfryEnemyCustomLevelRarities = new Dictionary<string, int> {
                {"EGyptLevel", 50},
            ...
            */
            ...
            NetworkPrefabs.RegisterNetworkPrefab(SmallfryEnemy.enemyPrefab);
            ...
            Enemies.RegisterEnemy(SmallfryEnemy, BoundConfig.SpawnWeight.Value, Levels.LevelTypes.All, SmallfryEnemyTN, SmallfryEnemyTK);
